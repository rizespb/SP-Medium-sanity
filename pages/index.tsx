...
const Home: NextPage<Props> = ({ posts }) => {
  return (
    <div className="">
      ...
      <div className="flex justify-between items-center border-y bg-yellow-400 border-black py-10 lg:py-5">
        <div className="px-10 space-y-5">
          <h1 className="text-6xl max-w-xl font-serif">
            <span className="underline decoration-black decoration-4">Medium</span> is a place to write, read and
            connect
          </h1>
          <h2 className="">Discover stories, thinking, and expertise from writers on any topic.</h2>
        </div>
      ...
      {/* Posts */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 mg:gap-6 p-2 md:p-6">
        {posts.map((post) => (
