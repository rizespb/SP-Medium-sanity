    ...
    <main>
      ...
      <article className="max-w-3xl mx-auto p-5">
        ...
        <div className="flex items-center space-x-2">
          ...
          <p className="font-extralight text-sm" suppressHydrationWarning={true}>
        ...
        <div className="mt-10">
          <PortableText
            ...
            content={post.body} // ЗДЕСЬ ПРИХОДИТ ТЕКСТ С ТЕГАМИ И КАРТИНКАМИ
            serializers={{
      ...
      {submitted ? (
        <div className="flex flex-col p-10 my-10 bg-yellow-500 text-white max-w-2xl mx-auto">
          ...
          <p className="">Once it has been approved, it will appear bellow</p>
        </div>
      ) : (
...
export const getStaticProps: GetStaticProps = async ({ params }) => {
  ...
  return {
    props: { post },
    revalidate: 60, // after 60 seconds it wil update the old cache
  }
}
